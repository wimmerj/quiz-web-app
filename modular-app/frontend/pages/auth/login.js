// Modular Auth Page Script
// Wires up tabs, forms, demo buttons, terms modal, and API connectivity
...
(function () {
	...
	document.addEventListener('DOMContentLoaded', () => {
		// API client is initialized in api-client.js on DOMContentLoaded
		const waitForAPI = () =>
			new Promise((resolve) => {
		...
		waitForAPI().then(() => {
			...
			setupApiTest();
			updateServerStatus();
			safeLog('success', 'Login page initialized', { baseURL: window.APIClient.baseURL });
		});
	});
})();
